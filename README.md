...
**For optimization algorithm implementations of this algorithm (ie. Simulated Annealing and Genetic Algorithm), check [here](https://www.github.com/camelwater/String-Grouping-Optimization-Algorithms).**
